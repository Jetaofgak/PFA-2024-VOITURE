...
public class PrometeoCarController : Agent
{

    //CAR SETUP
    public RayPerceptionSensorComponent3D CheckpointSensor;
    ...
    //PRIVATE VARIABLES
      ...
      */
      ...
      protected float throttleAxis; // Used to know whether the throttle has reached the maximum value. It goes from -1 to 1.
      protected float driftingAxis;
      protected float localVelocityZ;
      protected float localVelocityX;
      protected bool deceleratingCar;
    ...
    void Awake()
    {
        ...
        RayPerceptionSensorComponent3D[] Raycomponents = GetComponents<RayPerceptionSensorComponent3D>();

        // Check if there are at least two instances of the component
        if (Raycomponents.Length >= 2)
        {
            // Pour avoir le deuxieme composant du sensor
            CheckpointSensor = Raycomponents[1];
    ...
    {
        CheckpointSensor.DetectableTags = t;
    }
}
